...
public class EntityConfigFox extends EntityConfigurationAnimal {
	...
	protected void entityInit() {
		...
		addTask(2, new AIPanic(effects, 1.3f, 25, new EntityDistanceSelector(effects.entity, 30f)));

		// TODO Split attack and MoveToAttack
		addTask(3, new AIMoveToTarget(effects, new SimpleSelector(EntityPlayer.class)));
		...
		addTask(6, new AITempt(effects, 1.0f, 20f, new ItemFilter.SimpleItemFilter(Items.egg)));
