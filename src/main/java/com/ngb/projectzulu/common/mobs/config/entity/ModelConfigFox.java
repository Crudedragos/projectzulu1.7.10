...
import com.ngb.projectzulu.common.core.ModelHelper;
...
public class ModelConfigFox extends ModelBase {
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		if (this.isChild) {
			...
			Optional<EntityTame> taming = ((EntityConfigurationAnimal) entity).getEntityEffects().getTamed();
			if (taming.isPresent() && taming.get().getCommand() == Command.SITTING) {
	...
	public void setLivingAnimations(EntityLivingBase par1EntityLiving, float par2, float par3, float par4) {
		...
		Optional<EntityTame> taming = ((EntityConfigurationAnimal) par1EntityLiving).getEntityEffects().getTamed();
